    ...
    <>
      <style>{`
        ...
        .reg-root {
          --accent: #84cc16;
          --accent-dark: #65a30d;
          --accent-bg: rgba(132,204,22,0.12);
          --accent-border: rgba(132,204,22,0.35);
          --accent-shadow: rgba(132,204,22,0.35);
        ...
        .reg-panel-right {
          ...
          position: relative;
          z-index: 1;
          background: linear-gradient(145deg, #1a2540 0%, #0f1929 60%, var(--bg) 100%);
        }
        ...
        .orb-a { width: 300px; height: 300px; background: var(--accent); top: -80px; right: -60px; }
        .orb-b { width: 200px; height: 200px; background: var(--accent-dark); bottom: 60px; left: -20px; }
        .orb-c { width: 140px; height: 140px; background: var(--accent); top: 45%; left: 30%; }
        ...
        .steps-heading span { color: var(--accent); }
        ...
        .form-card {
          ...
          max-width: 420px;
          background: var(--bg2);
          border: 1px solid rgba(3, 32, 57, 0.06);
          border-radius: 20px;
          padding: 44px 40px;
          box-shadow: 0 32px 80px rgba(99, 236, 236, 0.5), 0 0 0 1px rgba(255,255,255,0.03);
          position: relative;
        }
        ...
        .form-card-glow {
          ...
          inset: -1px;
          border-radius: 21px;
          background: linear-gradient(135deg, var(--accent-bg), transparent 50%, rgba(165,243,38,0.08));
          pointer-events: none;
          z-index: -1;
        }
